...
temp_file = "temp_hierarchical_graph.html"
...
final_file = "final_hierarchical_graph.html"
with open(final_file, 'w', encoding='utf-8') as f:
    f.write(html_content)

os.remove(temp_file)

print(f"Successfully generated final hierarchical graph at: {os.path.join(os.getcwd(), final_file)}")
